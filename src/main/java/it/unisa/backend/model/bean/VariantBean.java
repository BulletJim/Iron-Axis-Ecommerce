...
public class VariantBean implements Serializable {
    ...
    private transient InputStream nutrTablStream;
    ...
    public InputStream getNutrTablStream() {
        return nutrTablStream;
    }

    public void setNutrTablStream(InputStream nutrTablStream) {
        this.nutrTablStream = nutrTablStream;
    }
}